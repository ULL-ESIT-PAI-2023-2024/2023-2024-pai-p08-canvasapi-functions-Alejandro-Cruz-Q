 ...
 * @since 18 March 2024
 *           Description: Class that represents the sin function in the canvas
 *
 *
...
/**
 * Class that represents the sin function in the canvas
 * @class
 */
export class SinFunc extends MatFunction {
    color = 'red';
    /**
     * Create a new SinFunc
    ...
    /**
     * Draw the sin function in the axis on the canvas
     * @returns void
     */
    draw() {
        ...
        for (let i = startX; i < endX; i += step) {
            const sinY = Math.sin(i / this.getScale()) * this.getScale();
            this.getContext().lineTo(x + i, y - sinY);
        }
